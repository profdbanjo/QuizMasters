...
In order to run the tests, you must install plugins and packages in your editor. Depending on the editor, you may have to install email-validator. If other packages are needed, please install them according to your code editor. 
